...
document.querySelector("button").addEventListener("click", function() {
    document.querySelector(".place").innerHTML = HellcatDealership;
    document.querySelector(".creature-name").innerHTML = PopSmoke;
    document.querySelector(".color").innerHTML = let color = ultraLightbeam;
    document.querySelector(".color-2").innerHTML = beamLightultra;
    document.querySelector(".emotion").innerHTML = freaky;
    document.querySelector(".character").innerHTML = ChickenBakeKid;
    document.querySelector(".creature-name-again").innerHTML = ChickenBakeKid;
    document.querySelector(".number").innerHTML = 70;
    document.querySelector(".item").innerHTML = widebodyHellcat;
    document.querySelector(".character-again").innerHTML = ChickenBakeKid;
    document.querySelector(".item-2").innerHTML = narutopowers;
    document.querySelector(".verb").innerHTML = Didntpayattentioninenglish;
    document.querySelector(".adverb").innerHTML = see10;
    document.querySelector(".number-2").innerHTML = 68;
